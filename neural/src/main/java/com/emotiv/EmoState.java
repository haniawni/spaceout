...
public interface EmoState extends Library
{
	EmoState INSTANCE = (EmoState)
        ...
        */
        void ES_AffectivGetExcitementShortTermModelParams(Pointer state, DoubleByReference rawScore, DoubleByReference minScale, DoubleByReference maxScale);
         ...
         */
        void ES_AffectivGetMeditationModelParams(Pointer state, DoubleByReference rawScore, DoubleByReference minScale, DoubleByReference maxScale);
         ...
         */
        void ES_AffectivGetEngagementBoredomModelParams(Pointer state, DoubleByReference rawScore, DoubleByReference minScale, DoubleByReference maxScale);
         ...
         */
        void ES_AffectivGetFrustrationModelParams(Pointer state, DoubleByReference rawScore, DoubleByReference minScale, DoubleByReference maxScale);
